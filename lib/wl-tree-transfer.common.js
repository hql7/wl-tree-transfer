...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"6a7b87cc-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/tree-transfer/index.vue?vue&type=template&id=44d5e564&
...
// CONCATENATED MODULE: ./src/components/tree-transfer/index.vue?vue&type=template&id=44d5e564&
...
/* harmony default export */ var tree_transfervue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    addToAims: function addToAims(emit) {
      ...
      var root__ = this.rootPidValue || 0;
      /*
    ...
    fromTreeChecked: function fromTreeChecked(nodeObj, treeObj) {
      ...
      this.$nextTick(function () {
        _this3.$emit("left-check-change", nodeObj, treeObj, _this3.from_check_all);
      });
    },
    // 目标树选中事件 - 是否禁用穿梭按钮
    toTreeChecked: function toTreeChecked(nodeObj, treeObj) {
      ...
      this.$nextTick(function () {
        _this4.$emit("right-check-change", nodeObj, treeObj, _this4.to_check_all);
      });
    },
    // 源数据 总全选checkbox
      ...
      switch (type) {
        case 0:
          arrayDeWeighting = arrayCheckedNodes.filter(function (item) {
            if (!_this5.addressee.some(function (ite) {
              return ite[_this5.node_key] == item[_this5.node_key];
            })) {
              return item;
            }
          });
        ...
        case 1:
          arrayDeWeighting = arrayCheckedNodes.filter(function (item) {
            if (!_this5.Cc.some(function (ite) {
              return ite[_this5.node_key] == item[_this5.node_key];
            })) {
              return item;
            }
        ...
        case 2:
          arrayDeWeighting = arrayCheckedNodes.filter(function (item) {
            if (!_this5.secret_receiver.some(function (ite) {
              return ite[_this5.node_key] == item[_this5.node_key];
            })) {
              return item;
            }
      ...
      switch (type) {
        case 0:
          this.addressee = id == "all" ? [] : this.addressee.filter(function (item) {
            return item[_this6.node_key] != id;
          });
          break;
